class Guild:
    ...
    def __init__(self, guild_id, verification_channel=None, logs_channel=None, delegate_role=None, sponsor_role=None,
                 speaker_role=None, panelist_role=None, vip_role=None, verification_requests_channel=None):
    ...
    def from_json(cls, guild_obj: dict):
        return Guild(
            guild_id=guild_obj.get("guild_id"),
            ...
            verification_requests_channel=guild_obj.get("verification_request_channel")
        )